...
module.exports = {
  ...
  FONT_URL: process.env.NEXT_PUBLIC_FONT_URL || [
    ...
    // Merge all families into one Google Fonts stylesheet request.
    'https://fonts.googleapis.com/css2?family=Bitter:wght@300;400;700&family=Noto+Sans+SC:wght@300;400;500;700&family=Noto+Serif+SC:wght@300;400;500;700&display=swap'
  ],
