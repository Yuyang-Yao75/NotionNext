...
export default function getAllPageIds(
  ...
  const shouldRecoverEmptyView =
    BLOG.NOTION_ALLOW_EMPTY_VIEW_PAGE_SORT_FALLBACK &&
    hasQueryData &&
    pageSet.size === 0 &&
    !queryData.some(viewData => viewData?.reducerResults)
  if (!hasQueryData || shouldRecoverEmptyView) {
