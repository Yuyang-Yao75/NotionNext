...
const BLOG = {
  ...
  // Published post floor: prevents a partial Notion response from replacing a
  // healthy production deployment. Future posts may increase this count.
  SITE_DATA_MIN_POSTS: 4,
  ...
  // 欢迎语打字效果，Hexo、Matery、XuHome 主题共享；英文逗号隔开多个欢迎语。
  GREETING_WORDS:
